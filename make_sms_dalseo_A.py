...
OUTPUT_PATH = r"G:\내 드라이브\배민 자동화\달서A_문자링크.txt"
...
if group_c:
    result_text += "C그룹 링크:\n"
    result_text += make_sms_link(group_c) + "\n\n"
